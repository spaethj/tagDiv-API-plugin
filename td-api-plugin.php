	...
	function hook_td_global_after()
	{
		...
		td_api_module::add('td_module_210',
			array(
				...
				'uses_columns' => true,
				'category_label' => true,
				'class' => 'td_module_10 td_module_wrap td-animation-stack',     // custom css module class
			)
		);

		// Fork of td_module_8. Disable links on the titles.
		td_api_module::add('td_module_88',
			array(
				'file' => $this->plugin_path . '/includes/modules/td_module_88.php',
				'text' => 'Module 88',
				'img' => $this->plugin_url . '/images/panel/modules/td_module_88.png',
		...
		// Fork of header-style-9 for add DFP advertisement 1000x130 px.
		td_api_header_style::add('99',
			array(
				'text' => '<strong>Style 99 - </strong> Full logo on top + DFP ad 1000 x 130 px',
				'file' => $this->plugin_path . '/parts/header/header-style-99.php'
			)
		);
	}
